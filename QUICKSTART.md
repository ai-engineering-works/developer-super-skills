...
### Install from GitHub
```bash
claude plugin install https://github.com/selvakumarEsra/claude-skills
```

### Install via skills.sh
```bash
npx skills add selvakumarEsra/claude-skills
```
...
```bash
npx agent-skills-cli@latest add @selvakumarEsra/claude-skills
```
...
<!-- SKILL_COUNT -->70<!-- /SKILL_COUNT --> skills covering:
...
3. Try reinstalling: `/plugin uninstall fullstack-dev-skills@selvakumarEsra` then reinstall
...
- Open an [issue on GitHub](https://github.com/selvakumarEsra/claude-skills/issues)
