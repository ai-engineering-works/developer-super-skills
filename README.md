...
<p align="center">
<a href="https://trendshift.io/repositories/20667" target="_blank"><img src="https://trendshift.io/api/badge/repositories/20667" alt="SelvakumarEsra%2Fclaude-skills | Trendshift" style="width: 200px; height: 44px;" width="200" height="44"/></a>
...
<p align="center">
  ...
  <a href="https://github.com/selvakumarEsra/claude-skills/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/selvakumarEsra/claude-skills/ci.yml?branch=main&style=for-the-badge&label=CI" alt="CI"/></a>
</p>
...
```bash
# Add the marketplace
/plugin marketplace add selvakumarEsra/claude-skills

# Install the plugin
/plugin install fullstack-dev-skills@selvakumarEsra
...
**Full documentation:** [selvakumarEsra.github.io/claude-skills](https://selvakumarEsra.github.io/claude-skills)

## Skills

<!-- SKILL_COUNT -->70<!-- /SKILL_COUNT --> specialized skills across 12 categories covering languages, backend/frontend frameworks, infrastructure, APIs, testing, DevOps, security, data/ML, and platform specialists.
...
- **Issues:** [GitHub Issues](https://github.com/selvakumarEsra/claude-skills/issues)
- **Discussions:** [GitHub Discussions](https://github.com/selvakumarEsra/claude-skills/discussions)
- **Repository:** [github.com/selvakumarEsra/claude-skills](https://github.com/selvakumarEsra/claude-skills)

## Author

Built by [**selvakumarEsra**](https://selvakumarEsra.github.io) [<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linkedin/linkedin-original.svg" width="16" height="16" alt="LinkedIn"/>](https://www.linkedin.com/in/jeff-smolinski/)
...
[![Stargazers repo roster for @SelvakumarEsra/claude-skills](https://reporoster.com/stars/SelvakumarEsra/claude-skills)](https://github.com/SelvakumarEsra/claude-skills/stargazers)

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=SelvakumarEsra/claude-skills&type=date&legend=top-left)](https://www.star-history.com/#SelvakumarEsra/claude-skills&type=date&legend=top-left)

---

**Built for Claude Code** | **<!-- WORKFLOW_COUNT -->9<!-- /WORKFLOW_COUNT --> Workflows** | **<!-- REFERENCE_COUNT -->386<!-- /REFERENCE_COUNT --> Reference Files** | **<!-- SKILL_COUNT -->70<!-- /SKILL_COUNT --> Skills**
